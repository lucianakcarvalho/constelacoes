document.addEventListener('DOMContentLoaded', () => {
    ...
    const constellationsData = {
        orion: {
            ...
            lines: [
                ['o3', 'o1'], ['o3', 'o2'], ['o1', 'o4'], ['o2', 'o6'],
                ['o4', 'o5'], ['o5', 'o6'], ['o4', 'o7'], ['o6', 'o8'],
                ['o2', 'o9'], ['o9', 'o10'], ['o10', 'o11']
            ]
        },
        ursa_major: {
            stars: [
    ...
    if(hoverCanvas) {
        ...
        const hoverData = [
            ...
            },
            {
                ...
                lines: [
                    [0, 1], [0, 2], [1, 2], // Triângulo da cauda
                    [1, 5], [2, 3], // Corpo
                    [3, 4], [4, 5], [5, 6], [6, 7], [7, 8] // Foice (Cabeça)
                ]
            }
        ];
        ...
        function drawHoverMap() {
            ...
            hoverData.forEach(constell => {
                ...
                hoverCtx.strokeStyle = isHovered ? 'rgba(110, 231, 183, 0.8)' : 'rgba(255, 255, 255, 0.15)';
